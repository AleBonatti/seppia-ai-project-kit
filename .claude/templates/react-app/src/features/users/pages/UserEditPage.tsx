...
export default function UserEditPage() {
  ...
  return (
    <div className="flex flex-col gap-(--gap)">
      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            {!isNew && (
              <p className="text-[13px] text-(--muted) mt-[2px]">Catherine Robertson · Editor</p>
            )}
          </div>
        </div>
      ...
      {/* Tabs */}
      <Tabs items={TAB_ITEMS} activeId="profile" onChange={() => {}} />
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="min-w-0">
              <div className="flex gap-2 mb-2">
                <Button size="sm" leftIcon={<Upload01Icon size={14} strokeWidth={1.8} />}>Upload</Button>
      ...
      <Card>
        ...
        <div className="flex items-center justify-between gap-3 flex-wrap border-t border-(--border) pt-5 mt-5">
          ...
          <div className="flex gap-[9px] ml-auto">
            <Button variant="secondary" asChild><Link to="/admin/users">Cancel</Link></Button>
